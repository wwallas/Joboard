...
(17, '2018_10_26_151600_create_webtechnos_table', 4),
...
INSERT INTO `profile_webteches` (`id`, `user_id`, `webtechno_id`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `webtechnos`
--

DROP TABLE IF EXISTS `webtechnos`;
CREATE TABLE IF NOT EXISTS `webtechnos` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `webtechnos`
--

INSERT INTO `webtechnos` (`id`, `description`, `created_at`, `updated_at`) VALUES
(1, 'php', NULL, NULL),
(2, 'vue.js', NULL, NULL);
COMMIT;
